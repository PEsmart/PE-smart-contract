<?php
return [
    'IP acquisition failed, please login again'  =>'IP获取失败，请重新登录',
    'China IP does not allow access'  =>'中国IP不允许访问',
    'User center'                           => '会员中心',
    'Register'                              => '注册',
    'Login'                                 => '登录',
    ...
    'Illegal submission'                    => '非法提交！',
    'Member contract address cannot be empty'=> '会员合约地址不能为空',
    'There is no recommender in the system' => '系统不存在推荐人',
    'The contract address already exists'   => '已存在该合约地址',
    'There is no recommender for users to invest in'   => '推荐人没有进行投资，无法推荐用户',
